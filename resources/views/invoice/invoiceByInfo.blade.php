...
<div class="clearfix"></div>
  ...
  @if ($client['name'] == 'Walk In')
    ...
    <p class="mediumBlackText"> {{ isset($address['name']) ? $address['name'] : ''    }} </p>

      <p class="mediumBlackText"> {{ isset($address['mobile']) ? $address['mobile'] : ''  }} </p>

      <p class="mediumBlackText"> {{ isset($address['address']) ? $address['address'] : '' }} </p>
    ...
    <div class="info-item-2">
      ...
      <p class="mediumBlackText"> #Quotation </p>
    ...
    <div class="info-item-3">
      ...
      <p class="largeBlueText"> BDT {{  $order_info['total'] }} </p>
  ...
  @foreach ($order_detail as $p)
    ...
    <div class=" tableBody-container ">
      ...
      <div class="tableBody-item-1">
        ...
        <p class="mediumBlackText"> {{ $p['name']  }} </p>

        <p class="smallGreyText"> {{ $p['description']  }} </p>
  ...
  <div class="summary-item-1">
   ...
   <div class="summary-item-2">
    ...
    <div class="summary-item-3">
      ...
      <p> {{ $order_info['subtotal'] }} </p>

      <p> {{ $order_info['discount'] }} </p>

      <p> {{ $order_info['total'] }} </p>
